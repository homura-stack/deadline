(function (root) {
  ...
  const create = () => ({ mode: 'title', restored: 0, selected: 0, active: 0, elapsed: 0, unlockFrom: -1, route: [], origin: {x:480,y:300} });
  ...
  root.Deadline.journey = { areas, create, areaForWave, status, onMap, paused, enter, cleared, tick, restoreSeconds, restorationFrame, finaleFrame, finaleSeconds, smooth };
