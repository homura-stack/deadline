/* Historical contract captured from git show ce742ca5:game.js, not from the new tutorial. */
'use strict';
...
test('historical two-target practice uses normal five-second STOP and execution collision/score rules',()=>{
  const w=vm.runInNewContext(historicalFunction('configurePracticeWorld')+';configurePracticeWorld()',{S,C});
