...
test('TASK L keeps Wave tuning and all gameplay parameters intact',()=>{
...
test('TASK L feedback stays bounded and separates impact from reaction',()=>{
...
test('five briefing slides introduce Near Miss before FREEZE and preserve original relative order',()=>{
