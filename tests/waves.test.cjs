...
test('campaign Wave tuning reaches the simulation and assisted STOP without changing climax volleys',()=>{
 ...
 // These composition and timing values are objective contracts, not a claim about perceived difficulty.
